...
2. 로컬 PC서버와 12대의 가상 서버를 활용한 배치 작업과 실시간 작업이 함께 이루어지는 람다 아키텍트 형식의 데이터 파이프라인입니다.   
...
# Server Spec   
![안](https://user-images.githubusercontent.com/66659846/118815760-7d5d6f00-b8ec-11eb-9407-ccdbcb2fcae2.png)   
